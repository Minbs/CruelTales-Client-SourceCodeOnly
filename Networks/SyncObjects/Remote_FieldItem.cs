/*
 * Generated File : Remote_FieldItem
 * 
...
namespace CTC.Networks.SyncObjects.SyncObjects
{
	...
	public partial class FieldItem
	{
		...
		[SyncVar]
		protected FieldItemType _itemType;
		public FieldItemType ItemType => _itemType;
		protected Action<FieldItemType>? _onItemTypeChanged;
		public event Action<FieldItemType> OnItemTypeChanged
		{
			add => _onItemTypeChanged += value;
			remove => _onItemTypeChanged -= value;
		}
		public FieldItem()
		{
		}
		...
		public override bool TryDeserializeSyncReliable(IPacketReader reader)
		{
			...
			{
				if (!reader.TryReadUInt32(out var _itemTypeValue)) return false;
				_itemType = (FieldItemType)_itemTypeValue;
				_onItemTypeChanged?.Invoke(_itemType);
			}
			return true;
		}
