/*
 * Generated File : Remote_RedHoodMissionInteractor
 * 
...
namespace CTC.Networks.SyncObjects.SyncObjects
{
	...
	public partial class RedHoodMissionInteractor
	{
		...
		[SyncVar]
		protected RedHoodMission _mission;
		public RedHoodMission Mission => _mission;
		protected Action<RedHoodMission>? _onMissionChanged;
		public event Action<RedHoodMission> OnMissionChanged
		{
			add => _onMissionChanged += value;
			remove => _onMissionChanged -= value;
		}
		...
		public override bool TryDeserializeSyncReliable(IPacketReader reader)
		{
			...
			{
				if (!reader.TryReadByte(out var _missionValue)) return false;
				_mission = (RedHoodMission)_missionValue;
				_onMissionChanged?.Invoke(_mission);
			}
			return true;
		}
